...
public interface ReservationRepository extends JpaRepository<RESERVATION, Long> {
	  ...
	  @Query(value = "select r.r_idx,sp.nickname, d.d_date, d.d_starttime, d.d_endtime, d.d_startpoint, d.d_endpoint, d.d_commute, d.d_fee, d.d_startlon, d.d_startlat, d.d_endlon, d.d_endlat,r.r_confirm"
	  + " from RESERVATION r " 
	  + " join D_CARPOOL d " 
	  + " on d.dr_idx = r.dr_idx "
	  + " join PASSENGER sp " 
	  + " on sp.p_idx = r.p_idx "
	  + " where d.d_idx = : d_idx and r.r_confirm = 'B' ",nativeQuery = true ) 
