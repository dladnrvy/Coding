...
public class MainForSpring4 {
	...
	private static ApplicationContext ctx = 			
			new AnnotationConfigApplicationContext(AppContext3.class);
	...
	private static void processNewCommand(String[] args) {
		...
		MemberRegisetService2 service = 
				ctx.getBean("registService22", MemberRegisetService2.class);
	...
	private static void processChangeCommand(String[] args) {
		...
		ChangePasswordService2 service = 
				ctx.getBean("changePwService22", ChangePasswordService2.class);
