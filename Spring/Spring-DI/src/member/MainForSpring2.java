...
public class MainForSpring2 {
   ...
   public static void main(String[] args) throws IOException {
      ...
      System.out.println("");
      MemberRegisetService regisetService1 = ctx.getBean("registService", MemberRegisetService.class);
      MemberRegisetService regisetService2 = ctx.getBean("registService", MemberRegisetService.class);
